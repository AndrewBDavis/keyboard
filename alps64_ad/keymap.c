...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [0] = KEYMAP( \
        ...
        NO, LCTL,LGUI,LALT,              SPC,                   LALT, FN1, FN2,  NO),
    ...
    [2] = KEYMAP( \
        ...
        CAPS,  TRNS,  UP,TRNS,TRNS,TRNS,TRNS,  P4,  P5,  P6,TRNS,TRNS,TRNS,    TRNS, \
        TRNS,   LEFT,DOWN,RGHT,TRNS,TRNS,TRNS,  P1,  P2,  P3,TRNS,PAST,        TRNS, \
