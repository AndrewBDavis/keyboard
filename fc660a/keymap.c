...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
	...
	[1] = KEYMAP( \
        ...
        TRNS,	MUTE,VOLD,VOLU,TRNS,TRNS,TRNS,TRNS,TRNS,HOME,LEFT,RGHT,  	 PENT, 		 \
	...
	[2] = KEYMAP( \
        ...
        TRNS,NO, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,  P1,  P2,  P3,	SLSH,	 TRNS, 	  \
	...
	[3] = KEYMAP( \
        ...
        TRNS,	LEFT,DOWN,RGHT,TRNS,TRNS,TRNS,TRNS,  P4,  P5,  P6,TRNS,  	   TRNS, 		  \
        TRNS,NO, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,  P1,  P2,  P3,	SLSH,	 TRNS, 	  \
         FN3,TRNS,TRNS,          TRNS,                	P0,PDOT,TRNS,		 TRNS,TRNS,TRNS
	   ),
};
