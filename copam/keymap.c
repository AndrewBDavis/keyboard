...
KEYMAP(
	TRNS, TRNS, TRNS,   F1,   F2,   F3,   F4,   F5,   F6,   F7,   F8,   F9,  F10,  F11,  F12, TRNS,  TRNS, 	NLCK, SLCK, PAUS, TRNS, \
	TRNS, TRNS,  CAPS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,  PSCR, SLCK, PAUS,   UP, PGDN,	  PGUP, 	TRNS, TRNS, TRNS, TRNS, \
